...
// 임시 데이터
const candidateData = {
  'seoha': { name: '서하선', position: '전교회장', image: seoha, summary: '여러분의 든든한 버팀목이 되겠습니다!', description: '서하선 후보의 상세 소개입니다. (상세 내용)' },
  'eunseo': { name: '정은서', position: '2학년 부회장', image: eunseo, summary: '언제나 여러분의 목소리에 귀 기울이겠습니다!', description: '정은서 후보의 상세 소개입니다. (상세 내용)' },
  'inseo': { name: '조인서', position: '2학년 부회장', image: inseo, summary: '실천하는 열정으로 보답하겠습니다!', description: '조인서 후보의 상세 소개입니다. (상세 내용)' },
  'seoa': { name: '김서아', position: '1학년 부회장', image: seoa, summary: '긍정 에너지로 가득한 학교를 만들겠습니다!', description: '김서아 후보의 상세 소개입니다. (상세 내용)' },
  'haewon': { name: '이해원', position: '1학년 부회장', image: haewon, summary: '항상 여러분 곁에서 함께 하겠습니다!', description: '이해원 후보의 상세 소개입니다. (상세 내용)' },
};
